# 📋 28-DAY WEB/UI AUTOMATION MASTERY PLAN

> **This file is the single source of truth for the curriculum.**
> The Main Mentor (AGENTS.md) reads this file at startup to know what to teach, and references Sections 2 and 3 for daily note formatting rules.

---

## SECTION 1: THE 28-DAY PLAN
...
## SECTION 2: FILE GENERATION INSTRUCTIONS (Reference for Main Mentor)

The Main Mentor must generate content for the following files as the user progresses through the plan. These formats define the structure of each revision file.

### FILE 1: `webui-automation-masterclass.md` (One-Stop Theory & Concept Revision)

**Purpose:** This is the single master reference file to revise every concept, definition, syntax, and interview answer from the entire 28-day plan.
...
- For **Interview Walkthrough Scripts:** When a concept could be asked as "Walk me through how you do X", add a blockquote with `> **Interview Walkthrough Script:**` prefix containing the exact words the user should say.
...
**Purpose:** A library of prompts the user can paste into any AI to regenerate infinite practice drills for every practical skill in the plan.
...
* **Application [N] ([Context]):** [Detailed explanation of where this OOP concept is applied in the specific project, with class names and method names referenced]
```
...
### FILE 8: `maven-cli-cheatsheet.md` (Maven & CLI Quick Reference)
Format:
- Common Maven commands (clean, test, install, verify)
- Maven flags and system properties (-D flags, -P profiles)
- Surefire plugin commands for running specific test suites
- Environment-specific commands (e.g., -Denv=staging, -Dbrowser=chrome)

---

## SECTION 3: DAILY OUTPUT FORMAT (Reference for Main Mentor)

The Main Mentor must provide the necessary updates for ALL 8 files using this exact format when updating the files on disk directly:
